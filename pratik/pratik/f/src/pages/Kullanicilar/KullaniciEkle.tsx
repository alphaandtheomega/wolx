...
export default function KullaniciEkle() {
  ...
  return (
    <PageLayout>
      <Card className="overflow-hidden p-0 border-0 shadow-none  max-w-md">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3 pt-5 border-t border-gray-100 dark:border-gray-600">
                ...
                <Button
                  ...
                  className="h-12 px-6 rounded-lg bg-gradient-to-r from-teal-600 to-cyan-700 hover:from-teal-700 hover:to-cyan-800 text-foreground font-medium transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
                >
