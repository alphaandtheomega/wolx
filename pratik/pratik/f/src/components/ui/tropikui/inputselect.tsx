  ...
  return (
    <div className="relative flex items-center w-full">
      ...
      <button
        type="button"
        tabIndex={-1}
        className="absolute right-1 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-primary focus:outline-none"
        aria-label="Kayıtları Listele"
        onClick={onListClick}
      >
        {/* Lucide Layout List Icon */}
        <svg
